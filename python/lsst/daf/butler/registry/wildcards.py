...
class CollectionSearch(Sequence[str]):
    ...
    collections : `tuple` [ `str` ]
        Tuple of collection names, ordered from the first search to the last
        searched.
    ...
    data ID, giving preference to collections in which the order they are
    ...
    def fromExpression(cls, expression: Any) -> CollectionSearch:
        ...
        expression
            ...
            Duplicate entries will removed (preserving the first appearance of
...
class CollectionQuery:
    ...
    def fromExpression(cls, expression: Any) -> CollectionQuery:
        ...
        expression
            ...
            Duplicate collection names will removed (preserving the first
